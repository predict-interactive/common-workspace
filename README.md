# common-workspace
### (이슈 등록 >> 담당자 -셀프 가능- 지정 >> 슬랙 공유 -셀프 패스- >> 완료 후 closed)  
깃허브에서 간단히 수정 업데이트 가능하므로 필요한 내용 추가하세요.
...
[05 운영이슈-통합관리 바로가기](https://github.com/predict-interactive/05.vue_RPM-Service/issues/150)
